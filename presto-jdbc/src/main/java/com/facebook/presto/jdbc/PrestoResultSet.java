        ...
        implements ResultSet
{
    ...
    private final PrestoStatementClient client;
    ...
    PrestoResultSet(PrestoStatementClient client, long maxRows, Consumer<QueryStats> progressCallback)
            throws SQLException
    {
    ...
    private static List<Column> getColumns(PrestoStatementClient client, Consumer<QueryStats> progressCallback)
            throws SQLException
    {
            ...
            extends AbstractIterator<Iterable<List<Object>>>
    {
        ...
        private ResultsPageIterator(PrestoStatementClient client, Consumer<QueryStats> progressCallback)
        {
            this.client = requireNonNull(client, "client is null");
